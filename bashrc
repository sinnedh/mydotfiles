export PATH=/Applications/Postgres.app/Contents/Versions/9.3/bin:/usr/lib:/usr/local/bin:/usr/local/sbin:$PATH
...
alias l="echo; pwd; echo; ll; echo"
alias v="vim"
alias pg_config="/Applications/Postgres.app/Contents/Versions/9.3/bin/pg_config"
alias gti=git
alias tools="ssh ord-tools-01v"
